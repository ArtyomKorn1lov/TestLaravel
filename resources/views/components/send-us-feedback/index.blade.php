<form class="contacts__form form" id="contactsForm" method="post">
    @csrf
    <div class="form__body">
        <h4 class="small-header uppercase-text">
            Send us message
        </h4>
        ...
        <span class="form__error">
            Field "Full Name" is invalid! Enter min 4 symbols
        </span>

        <span class="form__label form__label_margine-top32">
            Email
        </span>
        ...
        <div id="formResults" class="form__result-group result-group">
            ...
            <span id="message" class="result-group__item"></span>
        </div>
    </div>
